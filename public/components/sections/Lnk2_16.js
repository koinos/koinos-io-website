...
export default function Lnk2_16() {
    return (
        <>
            <section id="lnk-2" className="bg--04 py-100 ct-01 content-section division">
                    ...
                    <div className="row d-flex align-items-center">
                        ...
                        <div className="col-md-6 order-last order-md-2">
                            <div className="txt-block left-column wow fadeInRight">
                                ...
                                {/* Title */}
                                <h2 className="s-46 w-700">Simplify your work, amplify productivity</h2>
                                {/* Text */}
