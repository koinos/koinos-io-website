...
export default function Features6_2() {
    return (
        <>
                    ...
                    <div className="row justify-content-center">
                        <div className="col-md-8">
                            <div className="section-title mb-70">
                                {/* Title */}
                                <h2 className="s-50 w-700">Efficiently create, manage and publish your content</h2>
                                {/* Text */}
                        ...
                        <div className="row row-cols-1 row-cols-md-2 row-cols-lg-4">
                            ...
                            <div className="col">
                                <div className="fbox-6 fb-1 wow fadeInUp">
                                    ...
                                    <div className="fbox-txt">
                                        <h6 className="s-20 w-700">Quick Access</h6>
                            ...
                            <div className="col">
                                <div className="fbox-6 fb-2 wow fadeInUp">
                                    ...
                                    {/* Text */}
                                    <div className="fbox-txt">
                                        <h6 className="s-20 w-700">File Manager</h6>
                                        <p>Luctus augue egestas undo ultrice and quisque lacus</p>
                                    </div>
                                </div>
                            ...
                            <div className="col">
                                <div className="fbox-6 fb-3 wow fadeInUp">
                                    ...
                                    {/* Text */}
                                    <div className="fbox-txt">
                                        <h6 className="s-20 w-700">Files Sharing</h6>
                                        <p>Luctus augue egestas undo ultrice and quisque lacus</p>
                                    </div>
                                </div>
                            ...
                            <div className="col">
                                <div className="fbox-6 fb-4 wow fadeInUp">
                                    ...
                                    {/* Text */}
                                    <div className="fbox-txt">
                                        <h6 className="s-20 w-700">Storage &amp; Backup</h6>
                                        <p>Luctus augue egestas undo ultrice and quisque lacus</p>
                                    </div>
                                </div>
