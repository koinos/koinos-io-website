...
export default function Lnk2_20() {
    return (
        <>
            <section id="lnk-2" className="pt-100 ws-wrapper content-section">
                <div className="container">
                    <div className="bc-5-wrapper bg--04 pattern-04 hidd bg--scroll r-16">
                            ...
                            <div className="row justify-content-center">
                                <div className="col-md-11 col-lg-9">
                                    <div className="section-title wow fadeInUp mb-60">
                                        {/* Title */}
                                        <h2 className="s-48 w-700">Build a customer-centric marketing strategy</h2>
                                        {/* Text */}
