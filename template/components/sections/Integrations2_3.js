...
export default function Integrations2_3() {
    return (
        <>
                        ...
                        <div className="row row-cols-1 row-cols-sm-3 row-cols-md-5">
                            ...
                            <div className="col">
                                <Link href="#" className="in_tool it-1 r-12 wow fadeInUp">
                                    ...
                                    {/* Title */}
                                    <h6 className="s-17 w-700">Google Drive</h6>
                                </Link>
                            </div>	{/* END TOOL #1 */}
                            {/* TOOL #2 */}
                            <div className="col">
                                <Link href="#" className="in_tool it-2 r-12 wow fadeInUp">
                                    ...
                                    {/* Title */}
                                    <h6 className="s-17 w-700">Dropbox</h6>
                                </Link>
                            </div>	{/* END TOOL #2 */}
                            {/* TOOL #3 */}
                            <div className="col">
                                <Link href="#" className="in_tool it-3 r-12 wow fadeInUp">
                                    ...
                                    {/* Title */}
                                    <h6 className="s-17 w-700">Zoom</h6>
                                </Link>
                            </div>	{/* END TOOL #3 */}
                            {/* TOOL #4 */}
                            <div className="col">
                                <Link href="#" className="in_tool it-4 r-12 wow fadeInUp">
                                    ...
                                    {/* Title */}
                                    <h6 className="s-17 w-700">Gmail</h6>
                                </Link>
                            </div>	{/* END TOOL #4 */}
                            {/* TOOL #5 */}
                            <div className="col">
                                <Link href="#" className="in_tool it-5 r-12 wow fadeInUp">
                                    ...
                                    {/* Title */}
                                    <h6 className="s-17 w-700">VLC Player</h6>
                                </Link>
                            </div>	{/* END TOOL #5 */}
                        </div>	{/* END TOOLS ROW */}
                        {/* MORE BUTTON */}
