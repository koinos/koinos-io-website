...
export default function Features12_3() {
    return (
        <>
                            ...
                            <div className="txt-block left-column wow fadeInRight">
                                ...
                                <ul className="simple-list">
                                    <li className="list-item">
                                        <p className="mb-0">Tempor sapien quaerat undo ipsum laoreet diam purus sapien a dolor
                                            ociis ultrice ipsum aliquam congue a dolor cursus congue varius magnis
                                        </p>
                                    </li>
                                </ul>
                                {/* Link */}
