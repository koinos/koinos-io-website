...
export default function Banner13_10() {
    return (
        <>
            <section id="banner-13" className="pt-100 banner-section">
                <div className="container">
                    {/* BANNER-13 WRAPPER */}
                    <div className="banner-13-wrapper bg--04 bg--scroll r-16 block-shadow">
                            ...
                            <div className="row d-flex align-items-center">
                                ...
                                <div className="col-md-7">
                                    <div className="banner-13-txt">
                                        ...
                                        {/* Button */}
                                        <Link href="#hero-22" className="btn r-04 btn--theme hover--theme">Get srarted - it's free</Link>
                                    </div>
