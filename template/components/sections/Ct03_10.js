...
export default function Ct03_10() {
    return (
        <>
            <section className="bg--04 py-100 ct-03 content-section division">
                    ...
                    <div className="row d-flex align-items-center">
                        ...
                        <div className="col-md-6 col-lg-5">
                            <div className="txt-block right-column wow fadeInLeft">
                                {/* Section ID */}
                                <span className="section-id color--grey">Control Data Access</span>
                                {/* Title */}
