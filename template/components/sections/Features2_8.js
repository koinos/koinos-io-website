...
export default function Features2_8() {
    return (
        <>
                    ...
                    <div className="row justify-content-center">
                        <div className="col-md-10 col-lg-9">
                            <div className="section-title mb-70">
                                {/* Title */}
                                <h2 className="s-50 w-700">Enhance your workflow and improve your productivity</h2>
                                {/* Text */}
                        ...
                        <div className="row row-cols-1 row-cols-md-3">
                            ...
                            <div className="col">
                                <div className="fbox-2 fb-3 wow fadeInUp">
                                    {/* Image */}
                                    <div className="fbox-img gr--whitesmoke h-175">
                                        <img className="img-fluid light-theme-img" src="/images/f_03.png" alt="feature-image" />
