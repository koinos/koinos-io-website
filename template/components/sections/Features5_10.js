...
export default function Features5_10() {
    return (
        <>
            <section id="features-5" className="bg--02 py-100 features-section division">
                    ...
                    <div className="fbox-wrapper text-center">
                        <div className="row d-flex align-items-center">
                            ...
                            <div className="col-md-6">
                                <div className="fbox-5 fb-1 bg--white-100 block-shadow r-16 wow fadeInUp">
                                    {/* Text */}
                            ...
                            {/* FEATURE BOX #2 */}
                            <div className="col-md-6">
                                <div className="fbox-5 fb-2 bg--white-100 block-shadow r-16 wow fadeInUp">
                                    {/* Image */}
