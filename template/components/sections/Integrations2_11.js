...
export default function Integrations2_11() {
    return (
        <>
            <section id="integrations-2" className="pt-100 integrations-section">
                <div className="container">
                    {/* INTEGRATIONS-2 WRAPPER */}
                    <div className="integrations-2-wrapper bg--white-400 bg--scroll r-12 text-center">
                        {/* SECTION TITLE */}
                        <div className="row justify-content-center">
                            <div className="col-md-10 col-lg-9">
                                <div className="section-title mb-50">
                                    {/* Title */}
                                    <h2 className="s-48 w-700">Easy integrate all your essential tools</h2>
                                    {/* Text */}
