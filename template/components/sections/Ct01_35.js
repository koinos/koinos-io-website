...
export default function Ct01_35() {
    return (
        <>
                    ...
                    <div className="row d-flex align-items-center">
                        ...
                        <div className="col-md-6 order-last order-md-2">
                            <div className="txt-block left-column wow fadeInRight">
                                {/* Section ID */}
                                <span className="section-id color--theme">Productivity Focused</span>
                                {/* Title */}
                                ...
                                {/* Button */}
                                <Link href="#projects-1" className="btn btn-sm r-04 btn--tra-black hover--theme">
                                    Explore our designs
                                </Link>
                            </div>
                        </div>	{/* END TEXT BLOCK */}
