...
export default function Features7_4() {
    return (
        <>
            <section id="features-7" className="py-100 features-section division">
                    ...
                    <div className="row justify-content-center">
                        <div className="col-md-8">
                            <div className="section-title mb-70">
                                {/* Title */}
                                <h2 className="s-52 w-700">Affordable solutions for all your creativity needs</h2>
                                {/* Text */}
                        ...
                        <div className="row row-cols-1 row-cols-md-2 row-cols-lg-4">
                            ...
                            <div className="col">
                                <div className="fbox-7 fb-1 r-12 wow fadeInUp">
                                    ...
                                    <div className="fbox-txt">
                                        <h6 className="s-20 w-700">Intuitive</h6>
                            ...
                            <div className="col">
                                <div className="fbox-7 fb-2 r-12 wow fadeInUp">
                                    ...
                                    {/* Text */}
                                    <div className="fbox-txt">
                                        <h6 className="s-20 w-700">Flexible</h6>
                                        <p className="p-sm">Feugiat primis ipsum and ultrice a semper lacus</p>
                                    </div>
                                </div>
                            ...
                            <div className="col">
                                <div className="fbox-7 fb-3 r-12 wow fadeInUp">
                                    ...
                                    {/* Text */}
                                    <div className="fbox-txt">
                                        <h6 className="s-20 w-700">Creative</h6>
                                        <p className="p-sm">Feugiat primis ipsum and ultrice a semper lacus</p>
                                    </div>
                                </div>
                            ...
                            <div className="col">
                                <div className="fbox-7 fb-4 r-12 wow fadeInUp">
                                    ...
                                    {/* Text */}
                                    <div className="fbox-txt">
                                        <h6 className="s-20 w-700">Efficient</h6>
                                        <p className="p-sm">Feugiat primis ipsum and ultrice a semper lacus</p>
                                    </div>
                                </div>
