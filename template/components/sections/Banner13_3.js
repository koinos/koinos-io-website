                            ...
                            <div className="row d-flex align-items-center">
                                ...
                                <div className="col-md-7">
                                    <div className="banner-13-txt color--white">
                                        {/* Title */}
                                        <h2 className="s-45 w-700">Getting started with Martex today!</h2>
                                        {/* Text */}
                                        <p className="p-lg">Congue laoreet turpis neque auctor turpis vitae dolor a luctus
                                            placerat and magna ligula cursus
                                        </p>
                                        {/* Button */}
                                        <Link href="/download" className="btn r-04 btn--theme hover--tra-white">Get srarted - it's free</Link>
                                    </div>
