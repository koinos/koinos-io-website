...
export default function Features6_5() {
    return (
        <>
                                ...
                                <div className="fbox-6 fb-1 wow fadeInUp">
                                    ...
                                    <div className="fbox-ico ico-55">
                                        <div className="shape-ico color--theme">
                                            {/* Vector Icon */}
                                            <span className="flaticon-graphics color--coal" />
                                            {/* Shape */}
                            ...
                            <div className="col">
                                <div className="fbox-6 fb-2 wow fadeInUp">
                                    ...
                                    <div className="fbox-ico ico-55">
                                        <div className="shape-ico color--theme">
                                            {/* Vector Icon */}
                                            <span className="flaticon-idea color--coal" />
                                            {/* Shape */}
                                            <svg viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M69.8,-23C76.3,-2.7,57.6,25.4,32.9,42.8C8.1,60.3,-22.7,67,-39.1,54.8C-55.5,42.7,-57.5,11.7,-48.6,-11.9C-39.7,-35.5,-19.8,-51.7,5.9,-53.6C31.7,-55.6,63.3,-43.2,69.8,-23Z" transform="translate(100 100)" />
                                            </svg>
                            ...
                            <div className="col">
                                <div className="fbox-6 fb-3 wow fadeInUp">
                                    ...
                                    <div className="fbox-ico ico-55">
                                        <div className="shape-ico color--theme">
                                            {/* Vector Icon */}
                                            <span className="flaticon-graphic color--coal" />
                                            {/* Shape */}
                                            <svg viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M69.8,-23C76.3,-2.7,57.6,25.4,32.9,42.8C8.1,60.3,-22.7,67,-39.1,54.8C-55.5,42.7,-57.5,11.7,-48.6,-11.9C-39.7,-35.5,-19.8,-51.7,5.9,-53.6C31.7,-55.6,63.3,-43.2,69.8,-23Z" transform="translate(100 100)" />
                                            </svg>
                            ...
                            <div className="col">
                                <div className="fbox-6 fb-4 wow fadeInUp">
                                    ...
                                    <div className="fbox-ico ico-55">
                                        <div className="shape-ico color--theme">
                                            {/* Vector Icon */}
                                            <span className="flaticon-search-engine-1 color--coal" />
                                            {/* Shape */}
                                            <svg viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M69.8,-23C76.3,-2.7,57.6,25.4,32.9,42.8C8.1,60.3,-22.7,67,-39.1,54.8C-55.5,42.7,-57.5,11.7,-48.6,-11.9C-39.7,-35.5,-19.8,-51.7,5.9,-53.6C31.7,-55.6,63.3,-43.2,69.8,-23Z" transform="translate(100 100)" />
                                            </svg>
