...
export default function Ct02_37() {
    return (
        <>
                    ...
                    <div className="row d-flex align-items-center">
                        ...
                        <div className="col-md-6">
                            <div className="txt-block right-column wow fadeInLeft">
                                {/* Section ID */}
                                <span className="section-id color--black">Control Data Access</span>
                                {/* Title */}
                                <h2 className="s-44 w-700">All your marketing data in one place</h2>
                                {/* Text */}
