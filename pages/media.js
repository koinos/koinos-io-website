            ...
            <section id="assets" className="mb-5 pt-5">
              ...
              <div>
                ...
                <div className="logo-section">
                  ...
                  <div className="download-box">
                    <img
                      src="/images/logo/png/koinos-mark.png"
                      alt="Main Logotype"
                      className="img-fluid h-8em"
                    />
                    <div>
                      <div className="dl-button">
                        <a
                          href="/images/logo/png/koinos-mark.png"
                          download
                        >
                          PNG
                        </a>
                      ...
                      <div className="dl-button">
                        <a
                          href="/images/logo/svg/koinos-mark.svg"
                          download
                        >
                          SVG
                        </a>
                  ...
                  <div>
                    <br />
                    <p>
                      The SVG colors can be changed with CSS.
                    </p>
                    <a
