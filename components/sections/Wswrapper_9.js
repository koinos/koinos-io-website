...
export default function Wswrapper_9() {
    return (
        <>
                            ...
                            <div className="row d-flex align-items-center">
                                ...
                                <div className="col-md-6 order-last order-md-2">
                                    <div className="txt-block left-column wow fadeInRight">
                                        {/* Section ID */}
                                        <span className="section-id color--black">Enhance Engagement</span>
                                        {/* Title */}
                                        <h2 className="s-44 w-700">Achieve success through data-driven decisions</h2>
                                        {/* List */}
