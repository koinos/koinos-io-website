...
export default function Hero27() {
    ...
    const subtle = 'Opensource, Free to Use, Modular, Scalable, and Fair Launched';
                            ...
                            <div className="col-md-10 col-lg-9">
                                <div className="hero-27-txt wow fadeInUp">
                                    ...
                                    <div className="btns-group">
                                        <VideoPopup style={4} channel='youtube' videoId={'Arzrcsia2DU'}/>
                                        <Link href="https://docs.koinos.io/" target="_blank" className="btn r-04 btn--tra-black hover--theme">Build on Koinos</Link>
                                    </div>
                                    {/* 
