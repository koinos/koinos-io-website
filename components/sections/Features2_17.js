...
export default function Features2_17() {
    return (
        <>
            <section id="features-2" className="py-100 features-section division">
                <div className="container">
                    ...
                    <div className="fbox-wrapper text-center">
                        <div className="row row-cols-1 row-cols-md-3 rows-2">
                            {/* FEATURE BOX #1 */}
                            <div className="col">
                                <div className="fbox-2 fb-1 wow fadeInUp">
                                    {/* Image */}
                                    <div className="fbox-img gr--whitesmoke h-170">
                                    ...
                                    <div className="fbox-txt">
                                        <h6 className="s-22 w-700">Quick Integration</h6>
                            ...
                            <div className="col">
                                <div className="fbox-2 fb-2 wow fadeInUp">
                                    {/* Image */}
                                    <div className="fbox-img gr--whitesmoke h-170">
                                        <img className="img-fluid light-theme-img" src="/images/f_09.png" alt="feature-image" />
                                        <img className="img-fluid dark-theme-img" src="/images/f_09_dark.png" alt="feature-image" />
                                    </div>
                                    {/* Text */}
                                    <div className="fbox-txt">
                                        <h6 className="s-22 w-700">Extremely Flexible</h6>
                            ...
                            {/* FEATURE BOX #4 */}
                            <div className="col">
                                <div className="fbox-2 fb-4 wow fadeInUp">
                                    {/* Image */}
                                    <div className="fbox-img gr--whitesmoke h-170">
                                    ...
                                    {/* Text */}
                                    <div className="fbox-txt">
                                        <h6 className="s-22 w-700">Marketing Integrations</h6>
                                        <p>Luctus egestas augue undo ultrice aliquam in lacus congue dapibus</p>
                                    </div>
                                </div>
                            ...
                            {/* FEATURE BOX #5 */}
                            <div className="col">
                                <div className="fbox-2 fb-5 wow fadeInUp">
                                    {/* Image */}
                                    <div className="fbox-img gr--whitesmoke h-170">
                                    ...
                                    {/* Text */}
                                    <div className="fbox-txt">
                                        <h6 className="s-22 w-700">Detailed Analytics</h6>
                                        <p>Tempor laoreet augue undo ultrice aliquam in lacusq luctus feugiat</p>
                                    </div>
                                </div>
                            ...
                            {/* FEATURE BOX #6 */}
                            <div className="col">
                                <div className="fbox-2 fb-6 wow fadeInUp">
                                    {/* Image */}
                                    <div className="fbox-img gr--whitesmoke h-170">
                                    ...
                                    {/* Text */}
                                    <div className="fbox-txt">
                                        <h6 className="s-22 w-700">Multiple Accounts</h6>
                                        <p>Egestas luctus augue undo ultrice aliquam in lacus feugiat cursus</p>
                                    </div>
                                </div>
