...
export default function Ct04_6() {
    return (
        <>
                    ...
                    <div className="row d-flex align-items-center">
                            ...
                            <div className="txt-block left-column wow fadeInRight">
                                ...
                                <div className="cbox-2 process-step">
                                    ...
                                    <div className="cbox-2-txt">
                                        <h5 className="s-22 w-700">Unique Design Elements</h5>
                                ...
                                <div className="cbox-2 process-step">
                                    ...
                                    {/* Text */}
                                    <div className="cbox-2-txt">
                                        <h5 className="s-22 w-700">Custom Integrations</h5>
                                        <p>Ligula risus auctor tempus feugiat dolor lacinia nemo purus in lipsum purus sapien
                                            quaerat a primis viverra tellus vitae luctus dolor ipsum neque ligula quaerat
                                        </p>
                                    </div>
                                ...
                                <div className="cbox-2 process-step">
                                    ...
                                    {/* Text */}
                                    <div className="cbox-2-txt">
                                        <h5 className="s-22 w-700">Drag &amp; Drop Editor</h5>
                                        <p className="mb-0">Ligula risus auctor tempus feugiat dolor lacinia nemo purus in lipsum
                        ...
                        <div className="col-md-6 order-first order-md-2">
                            <div className="img-block wow fadeInLeft">
                                <img className="img-fluid" src="/images/tablet-04.png" alt="content-image" />
                            </div>
                        </div>
