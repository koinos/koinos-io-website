...
export default function Reviews2_6() {
    return (
        <>
                        ...
                        <div className="row align-items-center row-cols-1 row-cols-md-2">
                            ...
                            <div className="col">
                                <div id="rw-2-4" className="review-2 bg--white-100 block-shadow r-08">
                                    ...
                                    <div className="review-txt">
                                        {/* Title */}
                                        <h6 className="s-20 w-700">Minimalistic &amp; Beautiful!</h6>
                                        {/* Text */}
                    ...
                    <div className="row">
                        <div className="col">
                            <div className="more-btn text-center mt-60 wow fadeInUp">
                                <Link href="/reviews" className="btn btn--tra-black hover--theme">Read all reviews</Link>
                            </div>
                        </div>
                    </div>
                </div>	   {/* End container */}
