  ...
  const items = [
    {
      ...
      description:
        "Just like the internet! The Koinos Mana system allows you to use the blockchain without spending, or even holding, ANY tokens. Mana recharges over time at a maximum of 5 days.<br/>Koinos is also free to use for developers with free-to-use smart contracts!",
