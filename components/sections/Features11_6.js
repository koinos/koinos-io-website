...
export default function Features11_6() {
    return (
        <>
                    ...
                    <div className="row justify-content-center">
                        <div className="col-md-10 col-lg-9">
                            <div className="section-title mb-70">
                                {/* Title */}
                                <h2 className="s-50 w-700">Digital marketing that drives results for your business</h2>
                                {/* Text */}
                        ...
                        <div className="row row-cols-1 row-cols-md-2 rows-3">
                                    ...
                                    <div className="fbox-ico-wrap">
                                        <div className="fbox-ico ico-50">
                                            <div className="shape-ico color--theme">
                                                {/* Vector Icon */}
                                                <span className="flaticon-responsive" />
                                                {/* Shape */}
                            ...
                            <div className="col">
                                <div className="fbox-11 fb-6 wow fadeInUp">
                                    ...
                                    {/* Text */}
                                    <div className="fbox-txt">
                                        <h6 className="s-22 w-700">Data Backup</h6>
                                        <p>Porta semper lacus cursus feugiat primis ultrice ligula risus ociis auctor and
                                            tempus feugiat impedit felis cursus auctor augue mauris blandit ipsum
                                        </p>
                                    </div>
