        ...
        <li aria-haspopup="true">
          ...
          <ul className="sub-menu">
            <li aria-haspopup="true" target="_blank">
              <Link href="https://docs.koinos.io">Documentation</Link>
            </li>
            <li aria-haspopup="true" target="_blank">
              <Link href="https://learnkoinos.xyz">Learn Koinos</Link>
            </li>
          </ul>
        </li>

        <li className="nl-simple" aria-haspopup="true">
          <Link href="/community" className="h-link">
            Community
          </Link>
        </li>

        <li className="nl-simple" aria-haspopup="true">
          <Link href="/#roadmap" className="h-link">
            Roadmap
          </Link>
        </li>
