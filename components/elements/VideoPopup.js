...
export default function VideoPopup({ style, channel, videoId }) {
    ...
    return (
        <>
            ...
            {style === 3 &&
                ...
                <a onClick={() => setOpen(true)} className="video-popup2 btn r-04 btn--tra-black hover--violet-100">Discover Koinos</a>
            }
            {style === 4 &&
                <a onClick={() => setOpen(true)} className="video-popup2 btn r-04 btn--theme hover--tra-black ico-20 ico-right">Discover Koinos <span className="flaticon-play" />
                </a>
            }
            {style === 5 &&
